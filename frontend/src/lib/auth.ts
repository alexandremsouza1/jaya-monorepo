...
export async function getNewAccessToken(accessToken:string, refreshToken:string) {
...
export async function getAccessToken(accessToken:string, refreshToken:string) {
